...
function RainDrops(x, y, endy, velocity, opacity) {
	...
	const color = {
		1:`rgba(61, 249, 248, ${this.opacity})`,
		2:`rgba(249, 217, 91, ${this.opacity})`,
		3: `rgba(248, 130, 211,${this.opacity})`,
	}
	this.draw = function() {
		c.beginPath();
		...
		c.lineWidth = 2;
		c.strokeStyle = color[randomNum(3,1)];
		c.stroke();
	}
...
for (let i = 0; i < 140; i++) {
	...
	let randomSpeed = randomNum(35, 10);
